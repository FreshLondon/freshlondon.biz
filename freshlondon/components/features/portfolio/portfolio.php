				...
				<section class="no-results not-found">
					...
					<div class="page-content">
						<? if ( current_user_can( 'publish_posts' ) ) : ?>
							...
							<p><? printf( wp_kses( __( 'Ready to publish your first project? <a href="%1$s">Get started here</a>.', 'freshlondon' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'post-new.php?post_type=jetpack-portfolio' ) ) ); ?></p>
